  ...
  return (
    <form action={formAction}>
      ...
      <button
        type="submit"
        disabled={pending}
        className="text-bone/20 hover:text-red-400 transition-colors text-lg leading-none shrink-0 w-6 h-6 flex items-center justify-center disabled:opacity-40"
