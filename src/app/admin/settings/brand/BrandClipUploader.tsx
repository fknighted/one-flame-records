      ...
      {localUrl ? (
        <div className="space-y-3">
          <video
            ...
            preload="metadata"
          />
          <p className="text-xs text-bone/60 font-mono break-all">{localUrl}</p>
        ...
        <label className="block cursor-pointer">
          ...
          <div className="flex items-center gap-3 rounded border border-dashed border-bone/20 px-4 py-4 hover:border-bone/40 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-bone/50 shrink-0">
